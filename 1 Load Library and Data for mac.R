...
#---------------------
# 2.1.1 phyto annual genus
# set working directory: phytoplankton annual
setwd("/Users/jiahuali1991/Dropbox/Jiahua's MSc thesis/Paper work/!Thesis/Part 2 Phytoplankton analysis/Data/Phytoplankton data/csv files/annual ice-free")
...
# K42: 1980-2008
phyto.K42.2008 <- read.csv("K42 1980-2008.csv", header=T, row.names=1)
#colnames(phyto.K42)
phyto.K42.2008.2p <- phyto.K42.2008[,c(1:10)]
phyto.K42.2008.1p <- phyto.K42.2008[,c(1:16)]
# 10 2% up; # 16 1% up
...
#---------------------
# 2.1.2 phyto annual division
# set working directory: phytoplankton annual
setwd("/Users/jiahuali1991/Dropbox/Jiahua's MSc thesis/Paper work/!Thesis/Part 2 Phytoplankton analysis/Data/Phytoplankton data/csv files/division/new")
# C1
phyto.C1.division <- read.csv("C1 phyto division.csv", header=T, row.names=1)
colnames(phyto.C1.division)
phyto.C1.division <- phyto.C1.division[,-9]

# C6
phyto.C6.division <- read.csv("C6 phyto division.csv", header=T, row.names=1)
colnames(phyto.C6.division)
phyto.C6.division <- phyto.C6.division[,-9]

# C9
phyto.C9.division <- read.csv("C9 phyto division.csv", header=T, row.names=1)
colnames(phyto.C9.division)
phyto.C9.division <- phyto.C9.division[,-9]

# E51
phyto.E51.division <- read.csv("E51 phyto division.csv", header=T, row.names=1)
colnames(phyto.E51.division)
phyto.E51.division <- phyto.E51.division[,-9]

# K39
phyto.K39.division <- read.csv("K39 phyto division.csv", header=T, row.names=1)
colnames(phyto.K39.division)
phyto.K39.division <- phyto.K39.division[,-9]

# K42: 
phyto.K42.division <- read.csv("K42 phyto division.csv", header=T, row.names=1)
colnames(phyto.K42.division)
phyto.K42.division <- phyto.K42.division[,-9]

# K45
phyto.K45.division <- read.csv("K45 phyto division.csv", header=T, row.names=1)
colnames(phyto.K45.division)
phyto.K45.division <- phyto.K45.division[,-9]

# S15
phyto.S15.division <- read.csv("S15 phyto division.csv", header=T, row.names=1)
colnames(phyto.S15.division)
phyto.S15.division <- phyto.S15.division[,-9]
#---------------------
...
setwd("/Users/jiahuali1991/Dropbox/Jiahua's MSc thesis/Paper work/!Thesis/Part 2 Phytoplankton analysis/Data/Phytoplankton data/csv files/seasonal")
...
phyto.E51.F <- phyto.E51.F[,c(1:11)]
...
setwd("/Users/jiahuali1991/Dropbox/Jiahua's MSc thesis/Paper work/!Thesis/Part 2 Phytoplankton analysis/Data/Environmetal data/csv files/Annual")
...
setwd("/Users/jiahuali1991/Dropbox/Jiahua's MSc thesis/Paper work/!Thesis/Part 2 Phytoplankton analysis/Data/Environmetal data/csv files/Seasonal")
...
#---------------------
# 4 Climate Variables
# 4.1.1 sunspot cycle and large climatic oscillation indices
# set working directory: Large-climatic cycle indices
setwd("/Users/jiahuali1991/Dropbox/Jiahua's MSc thesis/Paper work/!Thesis/Part 2 Phytoplankton analysis/Data/Oscillation and Fluctuation of Climate")
...
# set working directory: Large-climatic cycle indices
setwd("/Users/jiahuali1991/Dropbox/Jiahua's MSc thesis/Paper work/!Thesis/Part 2 Phytoplankton analysis/Data/seasonal data/csv")
...
setwd("/Users/jiahuali1991/Dropbox/Jiahua's MSc thesis/Paper work/!Thesis/Part 2 Phytoplankton analysis/Data/Ice phenology data")
...
# MEM variables data
# Set working directory
setwd("/Users/jiahuali1991/Dropbox/Jiahua's MSc thesis/Paper work/!Thesis/Part 2 Phytoplankton analysis/Data/MEM")
...
#---------------------
# 6 phyto annual food quality index (based on division)
# set working directory: phytoplankton annual
setwd("/Users/jiahuali1991/Dropbox/Jiahua's MSc thesis/Paper work/!Thesis/Part 2 Phytoplankton analysis/Data/Phytoplankton data/csv files")

# Load phyto food quality index data 
# all annaul phyto
phyto.FQI <- read.csv("Food Quality Index.csv", header=T)
# colnames(phyto.FQI)
# phyto.FQI
